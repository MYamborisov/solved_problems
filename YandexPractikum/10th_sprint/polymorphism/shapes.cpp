...
//enum class ShapeType { SHAPE, CIRCLE, RECTANGLE };
...
public:
    explicit Rectangle(double width, double height, Color color) : Shape(color), width_(width), height_(height) {}
...
public:
    explicit Circle(double radius, Color color) : Shape(color), radius_(radius) {}
